...
import { Users, FileText, ArrowRight, CheckCircle, Clock, Dumbbell, ChevronRight, ChevronLeft } from 'lucide-react';
      ...
      <header className="bg-slate-900/80 backdrop-blur-xl border-b border-slate-800 px-6 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-xl font-bold text-white">Therapist Dashboard</h1>
          </div>
          
          <div className="flex items-center gap-4">
            <div className="text-right">
              <p className="text-slate-400 text-sm">Welcome back</p>
              <p className="text-white font-semibold">Dr. {user.name}</p>
            </div>
            <button
              onClick={onLogout}
                ...
                {patients.map((patient, index) => (
                  ...
                  >
                    <div className="flex flex-wrap items-center justify-between gap-4">
                      ...
                      <div className="flex items-center gap-3">n                        {
                    }
                      <div className="flex items-center gap-3">
